...
import io.github.ithmal.itio.codec.sgip.message.DeliverResponse;
 ...
 */
public class DeliverResponseMessageCodec implements IMessageCodec<DeliverResponse> {

    @Override
    public DeliverResponse decode(ChannelHandlerContext ctx, long sequenceId, ByteBuf byteBuf) throws Exception {
